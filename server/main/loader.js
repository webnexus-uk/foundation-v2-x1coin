...
const Loader = function (logger, configMain) {
  ...
  this.handleConfigs = function () {
    ...
    if (fs.existsSync(normalizedPath + "x1coin.js")) {
      config = require(normalizedPath + "x1coin.js");
      ...
      throw new Error(
        "Unable to find x1coin.js file. Read the installation/setup instructions"
      );
    }
    return config;
  };
