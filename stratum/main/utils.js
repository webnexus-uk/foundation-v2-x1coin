  ...
  switch (type) {
    case "pubkey":
      return exports.encodeChunks([
        exports.getX1CoinOPCodes("OP_DUP"),
        exports.getX1CoinOPCodes("OP_HASH160"),
        address,
        exports.getX1CoinOPCodes("OP_EQUALVERIFY"),
        exports.getX1CoinOPCodes("OP_CHECKSIG"),
      ]);
    case "script":
      return exports.encodeChunks([
        exports.getX1CoinOPCodes("OP_HASH160"),
        address,
        exports.getX1CoinOPCodes("OP_EQUAL"),
      ]);
    case "witnesspubkey":
      return exports.encodeChunks([exports.getX1CoinOPCodes("OP_0"), address]);
    case "witnessscript":
      return exports.encodeChunks([exports.getX1CoinOPCodes("OP_0"), address]);
  }
};
...
exports.encodeBuffer = function (buffer, number, offset) {
  ...
  if (size === 1) {
    ...
    buffer.writeUInt8(exports.getX1CoinOPCodes("OP_PUSHDATA1"), offset);
    buffer.writeUInt8(number, offset + 1);
  } else if (size === 3) {
    buffer.writeUInt8(exports.getX1CoinOPCodes("OP_PUSHDATA2"), offset);
    buffer.writeUInt16LE(number, offset + 1);
  } else {
    buffer.writeUInt8(exports.getX1CoinOPCodes("OP_PUSHDATA4"), offset);
...
// https://github.com/p2pool/p2pool/blob/53c438bbada06b9d4a9a465bc13f7694a7a322b7/p2pool/x1coin/data.py#L218
...
exports.getX1CoinOPCodes = function (type) {
  switch (type) {
    case "OP_0":
      return 0;
    case "OP_PUSHDATA1":
...
exports.getEncodingLength = function (data) {
  return data < exports.getX1CoinOPCodes("OP_PUSHDATA1")
    ? 1
    : data <= 0xff
    ? 2
    : data <= 0xffff
...
exports.getMinimalOPCodes = function (buffer) {
  if (buffer.length === 0) return exports.getX1CoinOPCodes("OP_0");
  if (buffer.length !== 1) return;
  if (buffer[0] >= 1 && buffer[0] <= 16) {
    return exports.getX1CoinOPCodes("OP_RESERVED") + buffer[0];
  }
  if (buffer[0] === 0x81) return exports.getX1CoinOPCodes("OP_1NEGATE");
};
